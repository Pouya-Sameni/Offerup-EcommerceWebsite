...
const ContactForm = (userInfo) => {
    ...
    const [values, setValues] = useState({
      ...
      postal_code: userInfo.userInfo.address.postalCode || "",
  ...
  return (
    <Grid container spacing={3} alignItems="center">
      <Grid item xs={12}>
        <Typography variant="h6" style={{marginTop: 20}}>Contact Information</Typography>
      </Grid>
      <Grid item xs={12} sm={4}>
        <InputLabel htmlFor="firstname" position="top">
          First Name
        </InputLabel>
        <TextField
          name="firstname"
      ...
      <Grid item xs={12} sm={4}>
      <InputLabel htmlFor="add1" position="top">
           Street Address 1
        </InputLabel>
        <TextField
          name="address1"
      ...
      <InputLabel htmlFor="postalCode" position="top">
          Postal Code
        </InputLabel>
        <TextField
          name="postal_code"
      ...
      <Grid item xs={6} sm={2}>
      <InputLabel htmlFor="city" position="top">
          City
        </InputLabel>
        <TextField
          name="city"
